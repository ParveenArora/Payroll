...
class Odf
{
    ...
    public function setImage($key, $value)
    {
       ...
       $xml = <<<IMG
<draw:frame draw:style-name="fr3" draw:name="$filename" text:anchor-type="char" svg:width="{$width}cm" 
svg:height="{$height}cm" draw:z-index="3"><draw:image xlink:href="Pictures/$file" xlink:type="simple" 
