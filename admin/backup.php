                    ...
                    <div class="content_resize">
                        <div class="mainbar">
                            <div class="article">
                                ...
                                <br />
                                <h2><span>Take Backup of Database Payroll</span></h2>
                                <form method="post" action="backup_class.php">
                                    <div style="margin-left: 40%;margin-top: 5%;width: 250px;"><input type="submit" value="Click the button to take the backup"/></div>
                                </form>
                                <br/>
                            </div>
