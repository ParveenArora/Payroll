...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            function validate(){
                var m= document.forms["bank_slip"]["month"];
                var y= document.forms["bank_slip"]["year"];
                if(m.value!='' && y.value==''){
                ...
                else if((m.value=='' && y.value=='') && document.bank_slip.current.checked==false){
                    alert('Please Select One option');
                    m.focus();
                    return false;
                }
                else if((m.value!='' && y.value!='') && document.bank_slip.current.checked==true){
                    alert('Please Select One only');
                    m.value='';
                    y.value='';
                    document.bank_slip.current.checked=false;
                    m.focus();
                    return false;
                }
            }
                    ...
                    <div class="content_resize">
                        <div class="mainbar">
                            <div class="article">
                                ...
                                <br />
                                <h2><span>Bank Slip</span></h2>
                                <?php
                                include_once '../dbfiles/config.php';
                                ?>
                                <form name="bank_slip" method="post" action="bankslipdownload.php">
